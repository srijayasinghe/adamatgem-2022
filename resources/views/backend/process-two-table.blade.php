...
<div class="col-md-8">
    ...
    <div class="card card-primary">
      ...
      <form action="{{route('add.process_two')}}" method="POST"  enctype="multipart/form-data">
        {!! csrf_field() !!}
        <div class="card-body">
          ...
          <div class="form-group">
            ...
            <textarea type="text" id="textarea1" autofocus maxlength="30" class="form-control" id="exampleInputCategory" name="process_sub_header" placeholder="Enter Text" rows="3"></textarea>
        ...
        <div class="form-group">
            ...
            <textarea type="text" id="textarea2" autofocus maxlength="100" class="form-control" id="exampleInputCategory" name="process_sub_header2" placeholder="Enter Text" rows="3"></textarea>
        ...
        <div class="form-group">
            ...
            <textarea type="text" id="textarea3" autofocus maxlength="300" class="form-control" id="exampleInputCategory" name="process_sub_body" placeholder="Enter Text" rows="4"></textarea>
        ...
        <div class="form-group">
            ...
            <div class="input-group">
              <div class="custom-file">
                ...
                <input type="file" name="process_sub_image1" class="form-control" id="1exampleInputFile" onchange="loandFile2(event)">
