        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <select class="form-control" name="faq_category_id">
                  <option value="" selected="" disabled="">Select Faq Category Name</option>
                @foreach($faq_category as $faq_category)
                <option value="{{$faq_category->id}}">{{$faq_category->faq_category_name}}</option>
                @endforeach 
          ...
          <div class="form-group">
            ...
            <textarea type="text" id="textarea1" autofocus maxlength="120"  class="form-control" id="exampleInputCategory" name="faq_question" placeholder="Enter Faq Question"></textarea>
          ...
          <div class="form-group">
            ...
            <textarea type="text" id="textarea2" autofocus maxlength="1000"  class="form-control tinymce-editor" rows="5" cols="40" id="exampleInputCategory" name="faq_answer" placeholder="Enter Faq Answer"></textarea>
