...
<div class="col-md-8">
    ...
    <div class="card card-primary">
      ...
      <form action="{{route('add.clarity')}}" method="POST"  enctype="multipart/form-data">
        {!! csrf_field() !!}
        <div class="card-body">
          <div class="form-group">
            <label for="exampleInputCategory">Clarity Name</label>
            <input type="text" id="textarea1" autofocus maxlength="50" class="form-control" id="exampleInputCategory" name="clarity_name" placeholder="Enter Clarity">
          ...
          <div class="form-group">
            ...
            <textarea type="text" id="textarea2" autofocus maxlength="500" class="form-control" id="exampleInputCategory" name="clarity_description" placeholder="Enter Description" rows="3"></textarea>
